...
public class FolderAdapter extends BaseAdapter {
    ...
    private List<com.nativeModul.MultiImageSlector.bean.Folder> mFolders = new ArrayList<>();
     ...
     * @param folders
     */
    public void setData(List<com.nativeModul.MultiImageSlector.bean.Folder> folders) {
    ...
    @Override
    public com.nativeModul.MultiImageSlector.bean.Folder getItem(int i) {
        if(i == 0) return null;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (holder != null) {
            if(i == 0){
                ...
                if(mFolders.size()>0){
                    com.nativeModul.MultiImageSlector.bean.Folder f = mFolders.get(0);
                    if (f != null) {
    ...
    private int getTotalImageSize(){
        ...
        if(mFolders != null && mFolders.size()>0){
            for (com.nativeModul.MultiImageSlector.bean.Folder f: mFolders){
    ...
    class ViewHolder{
        ...
        void bindData(com.nativeModul.MultiImageSlector.bean.Folder data) {
            if(data == null){
                return;
            }
