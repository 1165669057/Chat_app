...
if (Platform.OS === 'ios') {
  var RCTScrollView = require('NativeModules').UIManager.RNChatScrollView;
  var RCTScrollViewManager = require('NativeModules').RNChatScrollViewManager;
}
else {
  var RCTScrollView = require('NativeModules').UIManager.RNFixedScrollView;
  var RCTScrollViewManager = require('NativeModules').RNFixedScrollViewManager;
}
...
if (Platform.OS === 'android') {
  var AndroidScrollView = requireNativeComponent('RNFixedScrollView', ScrollView);

} else if (Platform.OS === 'ios') {
  var RCTScrollView = requireNativeComponent('RNChatScrollView', ScrollView);
}
